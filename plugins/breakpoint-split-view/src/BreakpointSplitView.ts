...
class BreakpointSplitViewType extends ViewType {
  ...
  snapshotFromBreakendFeatureSideBySide(
    feature: Feature,
    ...
    const topMarkedRegion = { ...topRegion }
    const bottomMarkedRegion = { ...bottomRegion }
    topMarkedRegion.end = startPos + startMod + windowSize
    bottomMarkedRegion.start = endPos + endMod - windowSize
    const snapshot = {
      type: 'BreakpointSplitView',
      views: [
        {
